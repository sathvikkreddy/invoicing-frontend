...
export function CreateInvoiceDialog({
    ...
    const form = useForm<AddInvoice>({
        defaultValues: {
            ...
            bill_to_company: existingInvoice?.bill_to_company.documentId ?? '',
            ship_to_company: existingInvoice?.ship_to_company.documentId ?? '',
                                    ...
                                    <FormItem>
                                        ...
                                        <div className='flex items-center gap-2'>
                                            <p className='text-sm'>
                                                SLNP/
                                                {format(
                                                    getThisFinancialYear().from,
                                                    'yyyy'
                                                )}
                                                -
                                                {format(
                                                    getThisFinancialYear().to,
                                                    'yy'
                                                )}
                                                /
                                            </p>
